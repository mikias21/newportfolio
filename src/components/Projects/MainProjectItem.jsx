          ...
          <div>
            <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-1">
                <div className="h-2 w-2 bg-green-300 rounded-full -mt-3"></div>
                <small className="-mt-3 text-slate-300">Actively being developed</small>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <ul className="grid grid-cols-2 gap-3">
                {techs.map((tech, index) => (
                  <li 
                    key={index} 
                    className="flex items-center text-sm bg-slate-100 dark:bg-slate-700 rounded-full px-4 py-2"
                  >
